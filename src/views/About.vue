<template>
  <div class="about">
    <article class="bg-blue-50 w-1/2 ml-auto mr-8 mt-4 p-6 shadow-xl">
    ...
    <article class="bg-blue-50 w-1/3 mr-auto ml-12 p-6 shadow-lg">
      <p class="text-xl">
      ...
      <p class="text-xl mt-8">
        Please find the instructions on how to use this app on the
        <router-link to="/" class="underline">Home Page</router-link> by clicking on the
        <span class="font-semibold">'Instructions'</span> button.
      </p>
    </article>
    <article class="bg-blue-50 w-1/2 mx-auto mt-12 p-6 shadow-md">
      <p class="text-xl">
